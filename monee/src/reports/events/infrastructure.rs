...
currency_id as currency, actor_id as actor, payment_promise FROM event FETCH actors, currency, actor",
    ...
    mod tests {
        ...
        use crate::backoffice::{
            ...
            events::domain::{
                event::{DebtRegister, Event as AddEvent, Purchase},
        ...
        fn can_get_purchase_events() {
            ...
            tokio::runtime::Runtime::new().unwrap().block_on(async {
                ...
                save_repo.add(EventId::default(), AddEvent::Purchase(Purchase {
                    item: item_id,
        ...
        async fn can_get_debt_events() {
            ...
            save_repo
                .add(
                    EventId::default(),
                    AddEvent::RegisterDebt(DebtRegister {
                        amount: "1.00".parse().unwrap(),
                        currency_id,
                        actor_id,
